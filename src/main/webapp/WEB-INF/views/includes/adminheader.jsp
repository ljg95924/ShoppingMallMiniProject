...
<head>
	...
	<title>BIO11 ShoppingMall Admin Page</title>
...
<div id="wrapper">
	...
	<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="/admin/member/list">BIO11 ADMIN</a>
		</div>
		<!-- /.navbar-header -->
...
<%--			<!-- /.dropdown -->--%>
			<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
				...
				<ul class="dropdown-menu dropdown-user">
					<li><a href="/admin/member/modify?userId=admin"><i class="fa fa-user fa-fw"></i> User Profile</a></li>
...
<%--					<li><a href="/resources/pages/index.html"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a></li>--%>
					<%--						<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> 매출관리<span class="fa arrow"></span></a>--%>
					<%--							<ul class="nav nav-second-level">--%>
					<%--								<li><a href="/resources/pages/flot.html">Flot Charts</a></li>--%>
					<%--								<li><a href="/resources/pages/morris.html">Morris.js Charts</a></li>--%>
					<%--							</ul> <!-- /.nav-second-level --></li>--%>
					<li><a href="/admin/member/list"><i class="fa fa-users"></i> 회원관리</a></li>
					<li><a href="/admin/product/list"><i class="fa fa-tags"></i> 상품관리</a></li>
					<%--						<li><a href="#"><i class="fa fa-wrench fa-fw"></i> UI Elements<span class="fa arrow"></span></a>--%>
					<%--							<ul class="nav nav-second-level">--%>
					<%--								<li><a href="/resources/pages/panels-wells.html">Panels and Wells</a></li>--%>
					<%--								<li><a href="/resources/pages/buttons.html">Buttons</a></li>--%>
					<%--								<li><a href="/resources/pages/notifications.html">Notifications</a></li>--%>
					<%--								<li><a href="/resources/pages/typography.html">Typography</a></li>--%>
					<%--								<li><a href="/resources/pages/icons.html"> Icons</a></li>--%>
					<%--								<li><a href="/resources/pages/grid.html">Grid</a></li>--%>
					<%--							</ul> <!-- /.nav-second-level --></li>--%>
