...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header">Join Page</h1>
	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
				...
				<form  role="form" action="<c:url value='/member/join'/>" method="post">
					<div id="wrap">
						<div id="content">
							...
							<div class="row">
								<label>아이디</label><br>
								<input maxlength="15" type="text" id="id" name="userId" onchange="idCheck()">
								...
								<label>이름</label><br>
								<input type="text" id="name" name="userName" onblur="nameCheck()"><br>
								<span id="name_msg"></span><br>
								
								<label>주소</label><br>
								<input maxlength="15" type="text" id="address" name="userAddress" onblur="addressCheck()">
								<br><span id="address_msg" ></span><br>
								
								<label>생년월일</label><br>
								<input type="text" id="year" name="year" onblur="birth()">
								...
								<input type="text" id="day" name="day" onblur="birth()">
								<br>
								...
								<input type="radio" name="userGender" value="wm" id="woman">
								
								<br><label>본인 확인 이메일</label><br>
								<input type="email" id="userEmail" name="userEmail" onblur="emailCheck()" placeholder="email@gmail.com" size="24" ><br>
								<span id="email_msg"></span><br>
				
								<label>휴대전화</label><br>
								<input type="text" id="userPhone" name="userPhone" onblur="phoneCheck()" placeholder="010-****-****" size="24"><br>
								<span id="phone_msg"></span><br>
														
								<input type="button" value="회원가입" size="24" onclick="submitCheck()">
							</div>
						</div>
					</div>
				</form>				
...
var phoneBool = false;        // 전화번호
	...
	function submitCheck(e) {
		...
		console.log(idBool && pwBool && pwckcorBool && nameBool && addressBool && birthBool && emailBool && phoneBool);
